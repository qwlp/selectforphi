-- TheSeanApp Database Setup for Triggers Lessons
-- This file creates the necessary tables and sample data for learning about triggers
...
INSERT INTO transactions (user_id, recipient_id, note, amount, was_successful)
VALUES (7, 8, "Happy birthday!!", 50.00, true);

INSERT INTO transactions (user_id, sender_id, note, amount, was_successful)
VALUES (9, 11, "MTG Draft", 50.00, false);
...
INSERT INTO transactions (user_id, recipient_id, note, amount, was_successful)
VALUES (1, 5, "Payment for consultation", 250.00, true);

INSERT INTO transactions (user_id, sender_id, note, amount, was_successful)
VALUES (3, 7, "Rent payment", 1200.00, true);

-- Create audit tables for trigger lessons
...
SELECT 'TheSeanApp database setup complete!' AS status;
SELECT COUNT(*) AS user_count FROM users;
SELECT COUNT(*) AS transaction_count FROM transactions;
SELECT 'Audit tables created and ready for triggers' AS audit_status;
